ui <- page_navbar(
  ...
  nav_panel("Andrew", icon = icon("house"),
            page_sidebar(
              sidebar = sidebar(
              ...
              navset_card_underline(
                ...
                nav_panel("Revenue", icon = icon("dollar-sign"), plotlyOutput("revenue")),
                nav_panel("Seasonal Trends", icon = icon("icicles"),
                ...
                nav_panel("Order Complexity", icon = icon("chart-simple"),
                          selectInput("jobselect", "Select Jobs Analysis", choices = c(
                            "Jobs per customer", "Big Spenders SOs", "Other Customers SOs", "Avg. Jobs per SO"
  ...
  nav_panel("Jeff", icon = icon("chart-line"),
            navset_card_underline(
              title = "Customer Retention",
              nav_panel("Plot1", icon = icon("chart-line"), plotOutput("customerPlot")),
              nav_panel("Plot2", icon = icon("chart-line"), plotOutput("customerPlot_2")),
              nav_panel("Table", icon = icon("chart-simple"),
                        div(
                          style = "width: 100%; overflow-x: auto;",
                          selectInput("tableChoice", "Choose a table:", choices = c(
                            "cohort_count", "cohort_count_pct", "cohort_cumulative", "cohort_cumulative_pct"
  ...
  nav_panel("Dollada", icon = icon("calculator"),
            navset_card_underline(
              title = "What we learned",
              fluidPage(
                titlePanel("New Customer Analysis Dashboard"),
                sidebarLayout(
                  sidebarPanel(
                    selectInput("chart_type", "Select Chart:", choices = c(
  ...
  nav_panel("Gracie", icon = icon("calculator"),
