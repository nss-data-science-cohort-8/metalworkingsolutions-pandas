...
SELECT 
	...
	jmp_ship_organization_id AS customer_id
FROM jobs
"
...
8. 
```{r}
write_csv(jobs_query_result, "jobs.csv")
...
```{r}
write_csv(job_ops_23_query_result, "jobs_23.csv")
write_csv(job_ops_24_query_result, "jobs_24.csv")
```